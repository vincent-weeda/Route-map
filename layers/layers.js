...
ol.proj.get("EPSG:3067").setExtent([377793.152147, 6667272.949227, 406640.037230, 6685789.668809]);
var wms_layers = [];
...
var format_gpstracks298_4 = new ol.format.GeoJSON();
var features_gpstracks298_4 = format_gpstracks298_4.readFeatures(json_gpstracks298_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3067'});
var jsonSource_gpstracks298_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_gpstracks298_4.addFeatures(features_gpstracks298_4);
var lyr_gpstracks298_4 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_gpstracks298_4, 
                style: style_gpstracks298_4,
                interactive: true,
                title: '<img src="styles/legend/gpstracks298_4.png" /> gps tracks 29.8'
            });

lyr_CartoPositron_0.setVisible(true);lyr_helsinkiborder_1.setVisible(true);lyr_missedstreets_2.setVisible(true);lyr_routes_3.setVisible(true);lyr_gpstracks298_4.setVisible(true);
var layersList = [lyr_CartoPositron_0,lyr_helsinkiborder_1,lyr_missedstreets_2,lyr_routes_3,lyr_gpstracks298_4];
...
lyr_gpstracks298_4.set('fieldAliases', {'fid': 'fid', 'Area': 'Area', 'Distance': 'Distance', 'Date': 'Date', 'Time': 'Time', 'Pace': 'Pace', 'Elevation': 'Elevation', 'Link': 'Link', 'Streets': 'Streets', 'run': 'run', });
...
lyr_gpstracks298_4.set('fieldImages', {'fid': '', 'Area': '', 'Distance': '', 'Date': '', 'Time': '', 'Pace': '', 'Elevation': '', 'Link': '', 'Streets': '', 'run': '', });
...
lyr_gpstracks298_4.set('fieldLabels', {'fid': 'no label', 'Area': 'inline label', 'Distance': 'inline label', 'Date': 'inline label', 'Time': 'inline label', 'Pace': 'inline label', 'Elevation': 'inline label', 'Link': 'inline label', 'Streets': 'inline label', 'run': 'inline label', });
lyr_gpstracks298_4.on('precompose', function(evt) {
